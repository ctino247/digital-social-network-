...
<div class="max-w-2xl mx-auto space-y-6">
    ...
    <article class="bg-surface-container-low p-6 rounded-3xl border border-white/5 shadow-xl flex flex-col">
        ...
        <?php if (!empty($post['product'])): ?>
            <div class="p-5 rounded-3xl bg-surface-container-high border border-primary/20 mb-6 flex flex-col sm:flex-row sm:items-center justify-between gap-4 group">
